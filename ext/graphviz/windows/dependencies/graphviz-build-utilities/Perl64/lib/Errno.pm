...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAESTALE WSAENOBUFS WSAEDESTADDRREQ WSAECANCELLED WSAENETUNREACH
	WSAECONNREFUSED WSAENAMETOOLONG WSAEINVAL WSAECONNABORTED
	WSAEADDRNOTAVAIL WSAEDQUOT WSAEISCONN WSAENOTSOCK WSAELOOP WSAEREMOTE
	WSAEACCES WSAEINPROGRESS WSAENETRESET WSAEADDRINUSE WSAEPROTOTYPE
	WSAEBADF WSAEINTR WSAEINVALIDPROVIDER WSAENOTEMPTY WSAESOCKTNOSUPPORT
	WSAEINVALIDPROCTABLE WSAEOPNOTSUPP WSAEAFNOSUPPORT WSAENOMORE
	WSAEFAULT WSAENOTCONN WSAEPROVIDERFAILEDINIT WSAEDISCON
	WSAETOOMANYREFS WSAEMSGSIZE WSAEALREADY WSAEHOSTDOWN WSAENOPROTOOPT
	WSAEREFUSED WSAEPROCLIM WSAEUSERS WSAEHOSTUNREACH WSAESHUTDOWN
	WSAENETDOWN WSAEMFILE WSAEPFNOSUPPORT WSAETIMEDOUT WSAECONNRESET
	WSAEWOULDBLOCK WSAEPROTONOSUPPORT
    )],
);
