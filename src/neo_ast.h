...
extern NEO_EXPORT void node_block_init(node_block_t *self, block_scope_t scope); /* Intialize block and symbol tables. node_block_free() must NOT be called, everything is freed within the ast pool.  */
